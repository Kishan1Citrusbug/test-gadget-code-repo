import { Client } from "@gadget-client/quick-start-v3-test";
import { AppConfiguration } from "./AppConfiguration";
import { AppConnections } from "./AppConnections";
import { FastifyLoggerInstance } from "fastify";
import { Session, RequestData, GadgetMailer } from "./types";
...
export interface AmbientContext {
  ...
  sessionID?: string;
  /** All Quick Start V3 Test configuration values */
  config: AppConfiguration;
  /** A map of connection name to instantiated connection objects for Quick Start V3 Test */
  connections: AppConnections;
  /** A high performance structured logger which writes logs to the Logs Viewer in the Gadget Editor. */
  logger: FastifyLoggerInstance;
  /**
   * An instance of the API client for Quick Start V3 Test.
   *
