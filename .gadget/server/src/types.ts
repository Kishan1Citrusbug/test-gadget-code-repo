...
export type MailData = {
  ...
  html?: string;
  /** The From address displayed to users as to who the email came from. If using Gadget transport, must end in the app's approved subdomain, the value of GADGET_PRIMARY_DOMAIN found in Config. If one is not provided then a default address for the app will be used */
  from?: string | Address;
