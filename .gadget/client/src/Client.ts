...
export class Client implements AnyClient {
  ...
  */
  ...
  developmentApiRoot = "https://quick-start-v3-test--development.gadget.app/";
  productionApiRoot = "https://quick-start-v3-test.gadget.app/";
  applicationId = "61575";
  ...
  constructor(options?: ClientOptions) {
    ...
    if (normalizedEnvironment === developmentEnv) {
      const devHarnessExchange = mapExchange({
        onResult: (result) => {
