...
class Client {
  constructor(options) {
    this.developmentApiRoot = "https://quick-start-v3-test--development.gadget.app/";
    this.productionApiRoot = "https://quick-start-v3-test.gadget.app/";
    this.applicationId = "61575";
    ...
    */
    ...
    if (normalizedEnvironment === developmentEnv) {
      const devHarnessExchange = (0, import_core.mapExchange)({
        onResult: (result) => {
